    ...
    <nav>
      ...
      {user ? (
        <>
          ...
          >
            <img
              src="https://github.com/Iliya-hacker/mental-chat/blob/main/menu-bars.png?raw=true"
              alt="menu"
              style={{ opacity: showListMenu ? 0 : 1 }}
            />
            <img
              src="https://github.com/Iliya-hacker/mental-chat/blob/main/cross-menu-icon.png?raw=true"
              alt="menu-cross"
